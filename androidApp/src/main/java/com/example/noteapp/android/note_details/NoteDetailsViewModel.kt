...
class NoteDetailsViewModel @Inject constructor(
    ...
    val state = combine(
        ...
        noteColor
    ){title,titleFocused,content,contentFocused,color ->
        NoteDetailsState(
            noteTitle = title,
            isNoteContentHintVisble = content.isEmpty() && !contentFocused,
            isNoteTitleHintVisible = title.isEmpty() && !titleFocused,
            noteContent = content,
            noteColor = color
        )
